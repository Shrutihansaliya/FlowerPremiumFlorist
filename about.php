...
<!-- Mirrored from phuler.myshopify.com/pages/about by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 15:47:45 GMT -->
...
<head>
  ...
  <title>
  about &ndash; Phuler - Flower Shop Shopify Theme
  </title>
...
<!-- BREADCRUMBS SETCTION END -->
	...
	<div id="shopify-section-template--14143320096841__main" class="shopify-section">
<div class="about-us-area" id="section-template--14143320096841__main">
  <div class="container">
    <div class="row ">
      <div class="col-lg-6 col-md-7">
        <div class="overview-content-2 text-left">
           
          <h2>Welcome To <span>Flower Premium Florist</span></h2>
            
           
          <p class="peragraph-blog">Flower Premium Florist Shop is a designed and develoved from the ground up with the sole purpose of helping you to give an astonishing, the beautiful and user friendly website that will boost your product’s sales.</p>
          ...
          <div class="overview-btn mt-45">
            <a class="btn-style-2" href="all.php?cid=0">Shop now!</a>
          </div>
      ...
      <div class="col-lg-6 col-md-5">
        <div class="overview-img text-center">
           <img src="cdn/shop/files/about-us21a0.jpg?v=1613740208" alt="banner">
        </div>
      </div>
    </div>
  </div>
...
<style data-shopify>#section-template--14143320096841__main{margin-top: 80px;
    margin-bottom: 80px;}
  @media (min-width: 768px) and (max-width: 991px) {
    #section-template--14143320096841__main{margin-top: 80px;
      margin-bottom: 80px;}
  }
  ...
  #section-template--14143320096841__main .overview-content-2 > h2 {
    color: #242424;
}
  #section-template--14143320096841__main .overview-content-2 > h2 span {
    color: #ff3d2a;
}
  #section-template--14143320096841__main .overview-content-2 > h2::before {
    background-color: #ff3d2a;
}
  #section-template--14143320096841__main .overview-content-2 p {
    color: #242424;
}
  #section-template--14143320096841__main .btn-style-2 {
    background-color: #ff3d2a;
    color: #ffffff;
}
  #section-template--14143320096841__main .btn-style-2:hover {
...
<style>
  ...
  #section-footer .effect-snow {
    background-image: url(about.php\/\/via.placeholder.com\/500x500);
...
<!-- Mirrored from phuler.myshopify.com/pages/about by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 15:48:17 GMT -->
</html>
