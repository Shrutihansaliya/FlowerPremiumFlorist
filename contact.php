...
<!-- Mirrored from phuler.myshopify.com/pages/contact by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 15:48:17 GMT -->
...
<head>
  ...
  <title>
  contact &ndash; Phuler - Flower Shop Shopify Theme
  </title>
...
<!-- BREADCRUMBS SETCTION END -->
	...
	<div id="shopify-section-template--14143320129609__main" class="shopify-section"><div class="contact-us" id="section-template--14143320129609__main">
  <div class="container">
    
    <div class="row">
      <div class="col-12">
        <div class="contact-page-title mb-40 text-left">
...
<!--                <p>You address will be here Lorem Ipsum text</p>-->
                <p>123-125, Avadh Zone near sarthana jakatnaka,surat</p>
            ...
            <div class="col-lg-4 col-md-4">
              <div class="contact-information contact-mrg">
                ...
                <p>
                  ...
                  <a href="01234%20567%20890.php">+9176876 45456</a>
                
                   
                  <a href="01234%20567%20891.php">+9198652 34345</a>
...
<!--              <div class="contact-information contact-mrg">
                ...
                <p>
                  ...
                  <a href="info%40example.com">info@example.com</a>
...
<form method="post" action="https://phuler.myshopify.com/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" /><input type="hidden" name="utf8" value="✓" />


<div class="row">
  <div class="col-lg-6">
    <div class="contact-form-style mb-20">
      <input type="text"  name="contact[name]" id="contactFormName" value="" placeholder="Name">
    </div>
  </div>
  <div class="col-lg-6">
    <div class="contact-form-style mb-20">
      <input type="text" name="contact[email]" id="contactEmail" value="" placeholder="Email">
    </div>
  </div>
  <div class="col-lg-12">
    <div class="contact-form-style mb-20">
      <input name="contact[subject]"  id="contactSubject" placeholder="Subject" type="text"  value="">
    </div>
  </div>
  <div class="col-lg-12">
...
</div><style data-shopify>#section-template--14143320129609__main{padding-top: 70px;
    padding-bottom: 55px;}
  @media (min-width: 768px) and (max-width: 991px) {
    #section-template--14143320129609__main{padding-top: 70px;
      padding-bottom: 55px;}
  }
  @media (max-width: 767px) {
    #section-template--14143320129609__main{padding-top: 70px;
      padding-bottom: 55px;}
  }</style><script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBmGmeot5jcjdaJTvfCmQPfzeoG_pABeWo"></script>
<script>
  function init() {
    var mapOptions = {
      zoom: 11,
    ...
    var marker = new google.maps.Marker({
      ...
      map: map,
      icon: '//phuler.myshopify.com/cdn/shop/files/map_small.png?v=1613740207',
        ...
        <div class="footer-widget footer-widget-red footer-black-color mb-40">
          ...
          <div class="footer-about">
            ...
            <div class="footer-contact mt-20">
              <ul>
                <li>Address: 123 Main Street, Anytown, Surat CA 12345 - INDIA.</li>
                <li>Telephone: 98546 87564</li>
                <li>Email: flowerflorist@gmail.com</li>
              </ul>
            </div>
          </div>
      ...
      <div class="col-lg-2 col-md-6 col-sm-6" id="block-1533616774081">
        <div class="footer-widget mb-40">
          ...
          <div class="footer-content">
            ...
            <li><a href="shipping-policy.php">Privacy Policy</a></li>
      ...
      <div class="col-lg-2 col-md-6 col-sm-6" id="block-1533616783543">
        <div class="footer-widget mb-40">
          ...
          <div class="footer-content">
            ...
            <li><a href="shipping-policy.php">International Orders</a></li>
...
<style>
  ...
  #section-footer .effect-snow {
    background-image: url(contact.php\/\/via.placeholder.com\/500x500);
...
<!-- Mirrored from phuler.myshopify.com/pages/contact by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 15:48:22 GMT -->
</html>
