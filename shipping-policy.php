...
<!-- BREADCRUMBS SETCTION END -->
  ...
  <div class="container">
      <b>
          Local Delivery</b><p>
Hand-delivered by our team to ensure freshness and quality.
Available for [list service areas, e.g., city].</p><b>

          Pickup</b><p>
              Customers may collect orders from our store during business hours.</P>

          <b>Shipping Times</b><p>
              <b>Local Deliveries:</b><br>
              Orders placed before will be delivered the same day.<br>
              Orders placed after this time will be delivered the next business day unless express delivery is selected.<br>
              Scheduled Deliveries: You may select your preferred delivery date and time slot during checkout.</p>

          <p><b>Order Processing</b><br>
              Orders are processed upon confirmation of payment.<br>
              For special or large orders, we recommend placing your order in advance.</p>

          <b>Delivery Address Requirements</b>
          <p>Ensure the shipping address provided is complete and accurate, including:<br>
          Recipient's full name.
          Contact number.</p>
          <p>We are not responsible for delays or non-delivery due to incorrect or incomplete information.</p>

          <b>Delivery Issues</b><br><p>

              Undeliverable Orders:<br>
Orders that cannot be delivered due to incorrect addresses or other unforeseen circumstances will be returned to the shop. Refunds are not available, but we can arrange for redelivery at the customer’s expense.
          </p>
          <b>International Shipping</b><br>
          Currently, we only offer local deliveries. International shipping is not available.<br><br>

          <b>Weather and Unexpected Delays</b><br>
While we strive to meet all delivery times, delays may occur due to weather, traffic, or other unforeseen factors. We will keep you informed and work to resolve any issues promptly.
