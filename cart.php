...
<!-- Mirrored from phuler.myshopify.com/cart by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 15:48:22 GMT -->
...
<!--  <div class="car-heading">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="text-capitalize sub-heading">Cart is Empty</h2>
        </div>
      </div>
    </div>
  </div>-->
  ...
  @media (min-width: 768px) and (max-width: 991px) {
    #section-template--14143319965769__main{padding-top: 60px;
      padding-bottom: 65px;}
  }
...
<style>
  ...
  #section-footer .effect-snow {
    background-image: url(cart.php\/\/via.placeholder.com\/500x500);
...
<!-- Mirrored from phuler.myshopify.com/cart by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 15:48:24 GMT -->
</html>
