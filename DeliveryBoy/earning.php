...
$queryss = "SELECT tblorder.*, tblitem.NAME, tbldeliveryboy.* FROM tblorder INNER JOIN tblitem ON tblorder.p_id = tblitem.ITEM_ID INNER JOIN tbldeliveryboy ON tblorder.O_ID = tbldeliveryboy.O_ID WHERE tbldeliveryboy.S_USERNAME = '$delivery_boy_username';";
...
<?php include 'Dheader.php'; ?>
        ...
        <table border="1" style="border-collapse: collapse" class="cent">
            ...
            while ($r = mysqli_fetch_assoc($qrt)) {
                ...
                echo "<td>{$r['DELIVERYSTATUS']}</td>";
                echo "<td>{$r['Earning']}</td>";
